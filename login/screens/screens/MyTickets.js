...
import { Icon, Left, Header } from 'native-base';
...
class MyTickets extends Component{
  static navigationOptions ={
    ...
    drawerIcon: ({ tintColor }) => (
     <Icon name="md-mail-open" style={{fontSize: 24, color: tintColor }}
     />
    ),
 }
  constructor(){
 ...
 // }
  ...
  render(){
    return(
     ...
     />
     <Text style={{fontSize: 20, marginTop: 5,marginLeft: 20, fontWeight: '500',color: '#fff'}}>MY TICKETS</Text>
